...
$Definition[" pin(s) correct, "]=" pin(nen) correct, ";
$Definition[" pin(s) wrong positioned."]=" pin(nen) verkeerd gepositioneerd.";
$Definition["Congratulations! You've guessed the code!"]="Gefeliciteerd! U heeft de code geraden!";
